...
use App\Http\Controllers\Api\ZZT\MedicalRecordController as PatientMedicalRecordController;
...
use App\Http\Controllers\Api\ZZT\PrescriptionController as PatientPrescriptionController;
...
Route::prefix('patient')->middleware(['auth:sanctum', 'role:patient'])->group(function () {
    ...
    Route::get('/medical-records/{id}', [PatientMedicalRecordController::class, 'show']);
    ...
    Route::post('/prescriptions/{id}/refill', [PatientPrescriptionController::class, 'refill']);
    Route::get('/medication-reminders', [PatientPrescriptionController::class, 'medicationReminders']);
});
